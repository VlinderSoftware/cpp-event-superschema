...
///                 Exceptions are not caught. If no specific handler is available and a
/// '__default__' handler is included in the handlers, that handler will be called by the dispatcher.
